local notify = loadstring(game:HttpGet('https://raw.githubusercontent.com/DevSloPo/Notification/refs/heads/main/Notification-obfuscated.lua'))()
...
notify("TROIK Hub丨注意", "记得在使用之前设置脚本或者默认设置！", 2)
notify("制作者:agon 二改:无优", "欢迎使用此脚本！", 2)
    ...
    if response == "执行" then
        ...
        CamlockButton.MouseButton1Click:Connect(function()
            ...
            if CamlockState then
                CamlockButton.Text = "关闭自瞄"
                CamlockEnabled = false
                CamlockTarget = nil
            else
                CamlockButton.Text = "开启自瞄"
                CamlockEnabled = true
                CamlockTarget = FindNearestEnemy()
            end
        end)

        notify("制作者:agon 二改:无优", "欢迎你使用此脚本！", 5)
...
TitleLabel.Text = "最强战场丨TROLK Hub"
TitleLabel.TextColor3 = Color3.fromRGB(255, 223, 223) 
...
AutoBlockLabel.Font = Enum.Font.SourceSans

CounterNotifierLabel.Name = "text2"
CounterNotifierLabel.Parent = MainFrame
CounterNotifierLabel.Text = "计数器通知"
...
CounterNotifierLabel.Font = Enum.Font.SourceSans
...
AutoBlockButton.Text = "启用自动格挡"
AutoBlockButton.TextColor3 = Color3.fromRGB(250, 0, 0)
...
CounterNotifierButton.Font = Enum.Font.SourceSans
CounterNotifierButton.Text = "启用通知"
...
MainFeaturesLabel.Font = Enum.Font.SourceSans
MainFeaturesLabel.Text = "主要功能"
MainFeaturesLabel.TextColor3 = Color3.fromRGB(255, 223, 223)
...
OtherFeaturesLabel.Font = Enum.Font.SourceSans
OtherFeaturesLabel.TextColor3 = Color3.fromRGB(255, 223, 223)
...
CloseRangeTextBox.Font = Enum.Font.SourceSans
...
LongRangeTextBox.Font = Enum.Font.SourceSans
...
NotifierRangeTextBox.Font = Enum.Font.SourceSans
...
DefaultSettingsButton.Font = Enum.Font.SourceSans
DefaultSettingsButton.Text = "设置默认"
...
M1AfterBlockLabel.Font = Enum.Font.SourceSans
M1AfterBlockLabel.Text = "格挡后M1"
...
BaitMessageTextBox.Font = Enum.Font.SourceSans
BaitMessageTextBox.PlaceholderText = "Message after baiting"
BaitMessageTextBox.Text = "Lol"
BaitMessageTextBox.TextColor3 = Color3.fromRGB(255, 223, 223)
...
CounterBaitLabel.Font = Enum.Font.SourceSans
CounterBaitLabel.Text = "反诱饵"
...
LEmoteLabel.Font = Enum.Font.SourceSans
LEmoteLabel.Text = "饿狼防反打空嘲讽"
...
DeathCounterNotifierLabel.Font = Enum.Font.SourceSans
DeathCounterNotifierLabel.Text = "死亡计数器通知器"
...
AutoCounterM1Label.Font = Enum.Font.SourceSans
AutoCounterM1Label.Text = "自动计数器M1"
...
M1ReachLabel.Font = Enum.Font.SourceSans
M1ReachLabel.Text = "远程M1"
...
M1ResetLabel.Font = Enum.Font.SourceSans
M1ResetLabel.Text = "M1复位"
...
AntiDeathCounterLabel.Font = Enum.Font.SourceSans
AntiDeathCounterLabel.Text = "反死亡计数器"
...
DeathCounterTeleport.Text = "死亡倒计时"
...
NoStunLabel.Font = Enum.Font.SourceSans
NoStunLabel.Text = "无眩晕"
...
NoFatigueLabel.Font = Enum.Font.SourceSans
NoFatigueLabel.Text = "无疲劳"
...
AutoBlockButton.MouseButton1Click:Connect(function()
    ...
    AutoBlockButton.Text = AutoBlockEnabled and "已开启自动格挡" or "已关闭自动格挡"
end)

CounterNotifierButton.MouseButton1Click:Connect(function()
    CounterNotifierEnabled = not CounterNotifierEnabled
    CounterNotifierButton.Text = CounterNotifierEnabled and "已开启计数器通知" or "已关闭计数器通知"
end)
...
local function InitializeTextBoxes()
    CloseRangeTextBox.Text = ""
    CloseRangeTextBox.PlaceholderText = "自动格挡(近距离移动)"
    LongRangeTextBox.Text = ""
    LongRangeTextBox.PlaceholderText = "自动格挡(长距离移动)"
    NotifierRangeTextBox.Text = ""
    NotifierRangeTextBox.PlaceholderText = "反通告程序(和诱饵)范围"
end
